...
return array(
	...
	'menu' => array(		
				...
				'animals_metas',
				'photos',
				'Animals Data' => ['categories', 'taxonomies', 'properties', 'environments', 'habitat_maps', 'references', 'videos'],
				'Tools' => ['Cropper' => 'page.admin.cropper', 'Photos Import' => 'page.admin.photos-import', 'Properties Import' => 'page.admin.properties-import', 'Geography Import' => 'page.admin.geography-import'],
				'users',
			),
